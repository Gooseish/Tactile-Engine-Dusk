...
{
    class Window_Target_Mass_Slow : Window_Target_Unit
    {
        ...
        public Window_Target_Mass_Slow(int unit_id, HashSet<Vector2> AoE, Vector2 loc)
        {
            initialize(loc);
        ...
        protected List<int> get_targets()
        {
            ...
            foreach (Vector2 loc in unit.mass_slow_tiles())
        ...
        public override void draw(SpriteBatch sprite_batch)
        {
            ...
            {
                Extra_Cursor_Sprite.draw(sprite_batch, Global.game_map.display_loc + cursor_clone_displacement);
            }
            sprite_batch.End();
            /*
            if (mode != 1)
