    ...
    class Game_Ai_State : Game_State_Component
    {
        ...
        protected bool update_ai_unit(Game_Unit unit, bool cont)
        {
            ...
            switch (unit.mission)
            {
                ...
                #region 11: Still Staff User
                case Missions.Still_staff_user:
                    switch (Ai_Action)
                    {
                        // Look for things to heal
                        case Ai_Actions.Idle:
                ...
                #region 12: Staff or Fight or Charge
                case Missions.Staff_or_fight_or_charge:
                    switch (Ai_Action)
                    {
                        // Look for things to heal
                        case Ai_Actions.Idle:
                ...
                #region 19: Fight or Staff or Charge
                case Missions.Fight_or_staff_or_charge:
                    switch (Ai_Action)
                    {
                        // Look for things to hit
                        case Ai_Actions.Idle:
                            ...
                            else
                            {
                                ...
                                {
                                    unit.mission = Missions.Staff_or_fight_or_charge;
                                }
                                cont = false;
                            }
                            break;
